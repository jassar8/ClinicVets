    ...
    public partial class VisitsView : UserControl
    {
        ...
        private void ValidateVisitInputs()
        {
            ...
            if (string.IsNullOrWhiteSpace(reason) ||
                string.IsNullOrWhiteSpace(diagnosis))
            {
                SetValidationMessage("יש למלא סיבת ביקור ואבחנה / טיפול", isValid: false);
                return;
            }
        ...
        private void SaveVisit_Click(object? sender, RoutedEventArgs e)
        {
            ...
            {
                UIHelper.ShowMessage(this, "יש למלא סיבת ביקור ואבחנה / טיפול");
                return;
            }
        ...
        private void MarkNoShowAndCreateNew_Click(object? sender, RoutedEventArgs e)
        {
            ...
            {
                reservedMedication = AppData.Medications.FirstOrDefault(m => m.Name == originalMedicationName);

                if (reservedMedication == null)
                {
                    UIHelper.ShowMessage(this, "לא ניתן לקבוע תור חדש כי התרופה של התור הישן כבר לא קיימת במלאי.");
                    return;
                }
                ...
                {
                    UIHelper.ShowMessage(this, $"אין מספיק מלאי לקביעת תור חדש עם אותה תרופה. צריך {originalMedicationQuantity}, זמין {availableAfterCancel}.");
                    return;
                }
            }
            ...
            Visit? visitBeingUpdated = null)
        {
            ...
            {
                UIHelper.ShowMessage(this, "יש להזין כמות תרופה");
                return false;
            }
            ...
            {
                UIHelper.ShowMessage(this, $"אין מספיק מלאי לתרופה שנבחרה. ביקשת {medicationQuantity}, אבל יש במלאי {availableStock}.");
                return false;
            }
        ...
        private void RestoreMedicationStock(Visit visit)
        {
            ...
            var medication = AppData.Medications.FirstOrDefault(m => m.Name == visit.MedicationName);

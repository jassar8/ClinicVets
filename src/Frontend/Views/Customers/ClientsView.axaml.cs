...
namespace ClinicVets.Desktop.Views.Customers;
...
public partial class ClientsView : UserControl
{
    ...
    private void RefreshClientsList()
    {
        ...
        if (ClientDetailsText is not null)
            ClientDetailsText.Text = $"???? {_items.Count} ??????";
        ...
        var card = new Button
        {
            ...
            Content = new StackPanel
            {
                ...
                Children =
                {
                    ...
                    new TextBlock { Text = $"?.?: {client.NationalId}", FontSize = 13, TextAlignment = TextAlignment.Center },

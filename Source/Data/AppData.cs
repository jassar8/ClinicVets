...
namespace ClinicVetsAvalonia.Data
{
    public static class AppData
    {
        ...
        private static void CreateTables()
        {
            ...
            string createVisitTreatmentLinesTable = @"
            ...
            using var treatmentLinesCommand = new SqliteCommand(createVisitTreatmentLinesTable, connection);
            treatmentLinesCommand.ExecuteNonQuery();
        }
